...
class TenderController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if (Auth::user()->role->id == '3') {
            return redirect()->route('admin.tender.index')->with('error', __('message.tender-delete'));
        } else if (Auth::user()->role->id == '2') {
            return redirect()->route('superadmin.tender.index')->with('error', __('message.tender-delete'));
        } else if (Auth::user()->role->id == '1') {
            return redirect()->route('serveradmin.tender.index')->with('error', __('message.tender-delete'));
        }
    }
