                            ...
                            <div class="row">
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-success">
                                        ...
                                        <a href="{{ route('superadmin.newses.index') }}"
                                            class="small-box-footer">{{ __('panel.dash-view-news') }} <i
                                ...
                                <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-primary">
                                        ...
                                        <a href="{{ route('superadmin.images.index') }}"
                                            class="small-box-footer">{{ __('panel.dash-view-gallery') }} <i
                                                class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div>
                                <!-- ./col -->
                                ...
                                {{-- <div class="col-lg-3 col-6">
                                    ...
                                    <div class="small-box bg-danger">
                                        ...
                                        <a href="{{ route('superadmin.events.pending') }}" class="small-box-footer">{{ __('panel.dash-view-event') }} <i class="fas fa-arrow-circle-right"></i></a>
                                    </div>
                                </div> --}}
                                <!-- ./col -->
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <input data-id="{{ $user->id }}" class="toggle-class"
                                                            ...
                                                            data-size="small" data-toggle="toggle" data-style="slow"
...
@elseif($user->status == '1')
    ...
    @endif
                                                    ...
                                                    <td>
                                                        <a href="{{ route('superadmin.editUserRole', $user->id) }}"
                                                            class="btn btn-sm btn-primary">Edit</a>
                                                        <a href="{{ route('superadmin.changeadminpassword', $user->id) }}"
                                                            class="btn btn-sm btn-warning">Change Password</a>
                                                        <button type="button" class="btn btn-sm btn-danger"
                                                            onclick="deleteUser({{ $user->id }})">Delete</button>
                                                        <form id="delete-form-{{ $user->id }}"
                                                            action="{{ route('superadmin.deleteUserRole', $user->id) }}"
