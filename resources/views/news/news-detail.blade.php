                ...
                <div class="row">
                    <div class="col-md-12 blog-post-hr image-block">
                        <div class="blog-post mb-30">
                            ...
                            <div class="post-meta">
                                <span class="badge badge-pill badge-mix" style="font-size: 12px; font-weight: 600; text-transform: capitalize;">Posted On: {{ date('d-M-Y', strtotime($newsDetail->date)) }}</span>
                            </div>
