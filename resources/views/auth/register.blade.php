...
@section('title', 'Kuno National Park - Registration System')
    ...
    <div class="card card-outline card-primary">
        <div class="logo text-center mt-3">
            <a href="{{ url('/') }}" target="_blank">
                <img src="{{asset('public/assets/images/KunoCheetahLogo.png')}}" alt="kuno-logo" class="img-fluid" width="100" height="100">
            </a>
        </div>

        {{-- <div class="card-header text-center p-0">
            <a href="{{ url('/') }}" class="h1" target="_blank"><b>Van</b>vihar</a>
        </div> --}}
