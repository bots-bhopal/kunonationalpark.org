...
<head>
    ...
    <title>Kuno National Park | Coming Soon</title>
...
<body>
    <div class="container mt-5">
        <div class="row mb-5">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="title">
                    <h1 class="text-white">
                        <span style="color: #f9c820; text-shadow: 2px 2px 4px #333;">Kuno </span> <span style="color: #f4edd2; text-shadow: 2px 2px 4px #333;">National Park</span>
                    </h1>
                </div>
                ...
                <div class="sub-title mt-5">
                    ...
                    {{-- <h4 class="text-white">
                        REDESIGNED BY BLUE OCEAN TECH SOLUTIONS PVT LTD
                    </h4> --}}
                </div>
            </div>
        </div>
    ...
    <script>
        function handleTickInit(tick) {
            ...
            Tick.count.schedule('today at 18:00', { timezone: '+05:30' }).onupdate = function(value) {
                tick.value = value;
            }
        }
    </script>
