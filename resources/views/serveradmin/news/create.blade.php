                        ...
                        <form action="{{ route('serveradmin.newses.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{old('slug')}}" placeholder="Enter News Slug" autocomplete="off">
                                        <span class="input-group-append">
...
@push('js')
    <script>
        $('#title').keyup(function(e) {
            $.get('{{ route('serveradmin.newses.slug.check') }}', {
                    'title': $(this).val()
                },
                function(data) {
                    $('#slug').val(data.slug);
