...
@section('title', '- Excursion and Charges')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12">
                ...
                <div class="full-pic">
                    <figure>
                        <img src="{{ asset('public/assets/images/knp-imgs/excursion.webp') }}" width="100%" alt="">
                    </figure>
                </div>

                @if (session('locale') == 'en')
                    <h3 class="text-center">This web page is under construction.</h3>
                @endif

                @if (session('locale') == 'hi')
                    <h3 class="text-center">यह वेब पेज निर्माणाधीन है।</h3>
                @endif
