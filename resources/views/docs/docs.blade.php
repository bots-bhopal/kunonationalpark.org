                    ...
                    <div class="col-md-12 col-lg-4 mb-80">
                        <div class="about-block gray-bg padding-40 clearfix">
                            ...
                            <div class="text-box">
                                ...
                                <a href="{{ route('vvnp.docs.download', $doc->original_filename) }}" class="btn btn-primary" style="background-color: #2d871c; color: #ffffff; border: 2px solid #2d871c"><i class="fa fa-download" style="margin-right: 4px;"></i>{{__('home.btn-download')}}</a>
                            </div>
                        </div>
                    </div>
                @empty
